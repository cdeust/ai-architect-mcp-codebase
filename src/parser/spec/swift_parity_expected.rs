// parser::spec::swift_parity_expected — the pinned pre-migration ground truth
// for the Swift parity suite (ADR-0055 §5 step 3).
//
...
// `swift_parity_tests.rs` (which kept the corpus, the record helpers and the
