...
|---|---|
| The artifact was built by our release workflow and stable tag | `gh attestation verify <file> --repo cdeust/ai-architect-mcp-codebase --signer-workflow cdeust/ai-architect-mcp-codebase/.github/workflows/release.yml --source-ref refs/tags/v0.9.1 --bundle <file>.sigstore.json` |
